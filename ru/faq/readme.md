...
*   Настраиваемые вкладки чатов: Админ, Боты, Каналы, Группы, Пользователи, Непрочитанные, С уведомлениями (как workmode в Telegram Desktop)#Configurable chat tabs for filtering your chats: Admin, Bots, Channels, Groups, Users, Unread, Unumted
